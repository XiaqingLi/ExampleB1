...
{  
  ...
  // Shape 1
  //  
  G4Material* shape1_mat = nist->FindOrBuildMaterial("G4_Ca");
  G4ThreeVector pos1 = G4ThreeVector(0, 0, 3.*cm);
        
  // Cylindrical shape
  G4double shape1_rmin =  0.*cm, shape1_rmax = 5.*cm;
  ...
  // Cylindrical shape
  G4double shape2_rmin =  0.*cm, shape2_rmax = 5.*cm;
  ...
  G4Tubs* solidShape2 =
    new G4Tubs("Shape2",                      //its name
               ...
               shape2_phimin, shape2_phimax); //its size
